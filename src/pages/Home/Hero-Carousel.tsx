...
export default function Carousel({
  ...
  return (
    <div className=" w-[200%] md:w-[80%] mx-auto absolute -left-[50%] -right-[50%] top-0 md:static overflow-hidden">
      <Swiper
        modules={[Navigation]}
        slidesPerView={3}
        centeredSlides={true}
      ...
      >
        {slides.map((slide, index) => (
          <SwiperSlide key={slide.id} className="p-4 w-[400px]">
            <div
              className={clsx(
                "flex items-center justify-center h-[200px] md:h-[240px]  bg-blue-500 text-white text-xl font-bold rounded-2xl overflow-hidden border-4 border-warning-400 transition-transform relative",
